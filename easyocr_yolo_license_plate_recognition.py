...
# regex: 2 letter + 2 number + 3 letters
...
# preprocessing the region before OCR
...
while cap.isOpened():
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            # draw simple rectanlge around license plate
            cv2.rectangle(frame,(x1,y1),(x2,y2),(0,255,0),3)

            # overlay zoomed in plate over detected plate
            if plate_crop.size > 0:
